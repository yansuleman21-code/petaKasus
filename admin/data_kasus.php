...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <div>
        <a href="cetak_kasus.php" target="_blank" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm mr-2">
                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_assoc($query)) {
                        ...
                        <tr>
                            ...
                            <td>
                                <?= $row['nama_desa'] ?><br>
                                <a href="http://maps.google.com/?q=<?= $row['latitude'] ?>,<?= $row['longitude'] ?>"
                                    target="_blank" class="small text-primary"><i class="fas fa-map-marker-alt"></i> Cek
                                    Peta</a>
                            </td>
                            ...
                            <td>
                                <?php
                                $badge = 'secondary';
                                if ($row['status_kasus'] == 'Selesai')
                                    $badge = 'success';
                                elseif ($row['status_kasus'] == 'Dalam Proses')
                                    $badge = 'warning';
                                elseif ($row['status_kasus'] == 'Ditolak')
                                    $badge = 'danger';
                                ?>
                            ...
                            <td class="text-center">
                                ...
                                <a href="hapus_kasus.php?id=<?= $row['id_kasus'] ?>" class="btn btn-danger btn-sm"
                                    onclick="return confirm('Yakin ingin menghapus data perkara ini?')" title="Hapus">
