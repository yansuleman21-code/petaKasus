    ...
    <nav class="navbar navbar-expand-lg navbar-custom shadow-sm fixed-top">
        <div class="container">
            ...
            <a class="navbar-brand fw-bold d-flex align-items-center" href="index.php">
                <img src="assets/img/logo.png" alt="Logo Kejaksaan" style="height: 40px; margin-right: 10px;">
            ...
            <div class="collapse navbar-collapse text-center" id="navbarNav">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <?php
                    // Start session kalau belum ada, biar bisa cek $_SESSION['admin']
                    ...
                    <li class="nav-item">
                        <?php if (isset($_SESSION['admin'])) { ?>
                            <a class="btn btn-warning ms-lg-3 fw-bold" href="admin/index.php">
